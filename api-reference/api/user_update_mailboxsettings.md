...
Update the settings for notifying people automatically when they send you email.
### Prerequisites
...
<!-- { "blockType": "ignored" } -->
```http
PATCH https://graph.microsoft.com/beta/me/mailboxSettings/automaticRepliesSetting
```
##### Response
